...
const AddTheatre = (props) => {
    ...
    const handleSubmit= (e) => {
        e.preventDefault();
        console.log(theatre);
        if(theatre.thumbnail){
            let formData = new FormData();
            formData.append('image', theatre.thumbnail);
            formData.append('TheatreName', theatre.theatreName);
            formData.append('LaunchDate', theatre.launchDate);
            formData.append('MovieSummary', theatre.movieSummary);
    ...
    return ( 
        <div className='text-align-center'>
            <h2 className="heading-constant">Add Theatre</h2>
